...
int main(int argc, char** argv)
{
  ...
  textures.addArea("Shark_normal_head2",sf::IntRect(0,1024,256,256));
  textures.addArea("Shark_weak_head2",sf::IntRect(512,1024,256,256));
  textures.addArea("Shark_crazy_head2",sf::IntRect(256,1024,256,256));
  textures.addArea("Shark_fins2",sf::IntRect(768,1024,64,128));
  textures.addArea("Shark_tail2",sf::IntRect(769,1152,63,128));
